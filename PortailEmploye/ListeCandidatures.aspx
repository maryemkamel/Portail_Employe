<%@ Page Title="" Language="C#" MasterPageFile="~/PageMaster.Master" AutoEventWireup="true" CodeBehind="ListeCandidatures.aspx.cs" Inherits="PortailEmploye.WebForm27" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <head>
        ...
        <body>
                  <div style="background-color:antiquewhite; height:70px;padding-left:20px;padding-top:20px;"><h4>Liste des candidatures</h4></div>
            ...
            <div class="container">
                ...
                <center>
                    <table class="T" id="table" runat="server">
                        <tr style="height:20px;width:650px;">
                            ...
                            <td style="width:400px;"><strong> <asp:Label ID="Label1" runat="server" Text="Employe" style="color:chocolate;font-size:30px;"></asp:Label></strong></td>
                             <td style="width:400px;"><strong> <asp:Label ID="Label2" runat="server" Text="Offre" style="color:chocolate;font-size:30px;"></asp:Label></strong></td>
                    ...
                    <asp:Label ID="Label5" runat="server" Text="Veuillez saisir le N° de l'offre traité :"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;
